	...
	def accept(self):
		...
		if receiver_friend_list:
			...
			if sender_friend_list:
				...
				self.save()
			return receiver_notification # Required to update notification in real time
...
def create_notification(sender, instance, created, **kwargs):
	"""
	Create notification after friend request creation
	"""
	if created:
