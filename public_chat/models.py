...
class PublicChatRoom(models.Model):
	...
	users = models.ManyToManyField(settings.AUTH_USER_MODEL, help_text="users who are connected to chat room.", null=True, blank=True)
...
class PublicRoomChatMessageManager(models.Manager):
    """
    Get all room messages ordered by newest
    """
