...
GROUP_CHAT_MSG_TYPE_PAGINATION_EXHAUSTED = 18  # No more 'chat' notifications to retrieve
GROUP_CHAT_MSG_TYPE_GET_UNREAD_NOTIFICATIONS_COUNT = 19 # Number of group chat notifications